...
public final class Util  {
    ...
    public static WebDriver setEnvironmentAndGetDriver(String driverName) {
        ...
        if (isUnix() && ("chrome").equalsIgnoreCase(driverName)) {
            System.setProperty("sudo chmod +x webdriver.chrome.driver", "src/test/resources/driver/chromedriver");
        } else if (isUnix() && ("firefox").equalsIgnoreCase(driverName)) {
            System.setProperty("sudo chmod +x webdriver.gecko.driver", "src/test/resources/driver/geckodriver");
